...
local function _1_()
  ...
  orgmode.setup({org_agenda_files = "~/orgfiles/**/*", org_default_notes_file = "~/orgfiles/refile.org", org_adapt_indentation = true, org_capture_templates = {t = {description = "Todo", template = "* TODO %?\nDEADLINE: %T"}, n = {description = "Note", template = "* %?\n"}, m = {description = "Meeting", template = "* %?\nSCHEDULED: %^t"}}})
